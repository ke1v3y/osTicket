...
implements Searchable {
    ...
    function postEmail($mailinfo, $entry=null) {
        ...
        ///////////////////////////////////////////////////////////////
        //// Begin CEAT modifications

        // This next line needs modified if C&amp;E switches to a new domain
        $ceatDomains = array("ceat.io", "ceadvancedtech.com", "cesales.com");

        foreach ($ceatDomains as $domainName) {
            if (stripos($mailinfo['email'], $domainName) !== false && $mailinfo['userClass'] == 'C') {
                $vars['thread-type'] = 'N';
            }
        }

        //// End CEAT modifications
        ///////////////////////////////////////////////////////////////
