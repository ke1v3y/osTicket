...
implements RestrictedAccess, Threadable, Searchable {
    ...
    function onNewTicket($message, $autorespond=true, $alertstaff=true) {
		...
		//***********************************************************************************************
		// C&E Custom code, sends an email to cc collaboraters when the ticket is created
		//Message Headers
		$headers = "MIME-Version: 1.0" . "\r\n";
		$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
		$headers .= "From: system@cesales.com" . "\r\n";
		...
		// This is so the notification only get sent to users with a C&E Email address
		...
		foreach ($to as $toOut)
		{
			...
			{
				// Filter to make sure email is sent only to C&E Employees
